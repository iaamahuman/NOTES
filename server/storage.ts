...
export class MemStorage implements IStorage {
  ...
  private createSampleNotes() {
    const sampleNotes = [
      {
        id: "note-1",
        title: "Introduction to Machine Learning - Complete Study Guide",
        description: "Comprehensive notes covering supervised learning, unsupervised learning, and neural networks. Includes examples and practice problems.",
        ...
        semester: "Fall 2024",
        fileType: "pdf",
        fileName: "ml-study-guide.pdf",
        fileSize: 2457600, // ~2.4MB
        filePath: "/sample/ml-study-guide.pdf",
        thumbnailPath: null,
      ...
      {
        id: "note-2", 
        title: "Calculus III - Vector Calculus and Line Integrals",
        description: "Detailed notes on vector fields, line integrals, Green's theorem, and Stokes' theorem with step-by-step solutions.",
        subject: "Mathematics",
        tags: ["calculus", "vector-calculus", "integrals", "multivariable"],
        course: "MATH 237",
        professor: "Prof. Sarah Wilson",
        semester: "Spring 2024",
        fileType: "pdf",
        fileName: "calc3-vector-calculus.pdf",
        fileSize: 1843200, // ~1.8MB
        filePath: "/sample/calc3-vector-calculus.pdf",
        thumbnailPath: null,
      ...
      {
        id: "note-3",
        title: "Quantum Mechanics - Schrödinger Equation Solutions",
        description: "Solutions to common quantum mechanics problems including particle in a box, harmonic oscillator, and hydrogen atom.",
        subject: "Physics",
        tags: ["quantum-mechanics", "schrodinger", "wave-functions", "physics"],
        course: "PHYS 301",
        professor: "Dr. Michael Chen",
        semester: "Fall 2024",
        fileType: "pdf",
        fileName: "quantum-mechanics-solutions.pdf",
        fileSize: 3145728, // 3MB
        filePath: "/sample/quantum-mechanics-solutions.pdf",
        thumbnailPath: null,
      ...
      },
      {
        ...
        description: "Visual guide to common organic chemistry reactions including SN1, SN2, E1, and E2 mechanisms.",
        subject: "Chemistry",
        tags: ["organic-chemistry", "reactions", "mechanisms", "synthesis"],
        course: "CHEM 220",
        professor: "Prof. Lisa Rodriguez",
        semester: "Spring 2024",
        fileType: "pdf",
        fileName: "organic-chem-mechanisms.pdf",
        fileSize: 2097152, // 2MB
        filePath: "/sample/organic-chem-mechanisms.pdf",
        thumbnailPath: null,
        uploaderId: "sample-user-1",
        downloads: 78,
        views: 198,
      ...
      {
        id: "note-5",
        title: "Data Structures and Algorithms - Big O Analysis",
        description: "Complete reference for time and space complexity analysis of common algorithms and data structures.",
        subject: "Computer Science",
        ...
        semester: "Fall 2024",
        fileType: "pdf",
        fileName: "big-o-analysis.pdf",
        fileSize: 1572864, // 1.5MB
        filePath: "/sample/big-o-analysis.pdf",
        thumbnailPath: null,
        uploaderId: "sample-user-2",
        downloads: 156,
        views: 334,
      ...
      {
        id: "note-6",
        title: "Microeconomics - Market Structures and Game Theory",
        description: "Analysis of perfect competition, monopoly, oligopoly, and game theory applications in economics.",
        subject: "Economics",
        tags: ["microeconomics", "market-structures", "game-theory", "competition"],
        course: "ECON 101",
        professor: "Prof. David Lee",
        semester: "Spring 2024",
        fileType: "pdf",
        fileName: "microeconomics-markets.pdf",
        fileSize: 2621440, // ~2.5MB
        filePath: "/sample/microeconomics-markets.pdf",
        thumbnailPath: null,
        uploaderId: "sample-user-3",
        downloads: 34,
        views: 87,
    ...
    sampleNotes.forEach(noteData => {
      const note: Note = {
        ...
        professor: noteData.professor || null,
        semester: noteData.semester || null,
        thumbnailPath: noteData.thumbnailPath || null,
      };
  ...
  private createSampleRatings() {
    const sampleRatings = [
      { id: "rating-1", noteId: "note-1", userId: "sample-user-2", rating: 5, review: "Excellent study guide! Really helped me understand the concepts." },
      { id: "rating-2", noteId: "note-1", userId: "sample-user-3", rating: 5, review: "Very comprehensive and well-organized." },
      { id: "rating-3", noteId: "note-2", userId: "sample-user-1", rating: 5, review: "Perfect for my calculus exam preparation!" },
      { id: "rating-4", noteId: "note-2", userId: "sample-user-3", rating: 5, review: "Clear explanations and great examples." },
      { id: "rating-5", noteId: "note-3", userId: "sample-user-1", rating: 5, review: "Saved my quantum mechanics grade!" },
      { id: "rating-6", noteId: "note-5", userId: "sample-user-3", rating: 5, review: "Best Big O reference I've found." },
    ];
