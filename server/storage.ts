...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const sampleUsers = [
      {
        ...
        password: "$2a$10$hash1", // Placeholder hash
        avatar: null,
        bio: "Math major passionate about calculus and linear algebra",
        university: "MIT",
        major: "Mathematics",
        year: "Junior",
        reputation: 150,
      ...
      },
      {
        ...
        avatar: null,
        bio: "Computer Science student specializing in algorithms",
        university: "Stanford",
      ...
      },
      {
        ...
        avatar: null,
        bio: "Physics PhD student researching quantum mechanics",
        university: "Caltech",
        major: "Physics",
        year: "Graduate",
        reputation: 310,
    ...
    const sampleNotes = [
      {
        ...
        description: "Comprehensive notes covering integration by parts, substitution, and partial fractions with examples",
        subject: "Mathematics",
        ...
        fileSize: 2048576,
        filePath: "/uploads/sample-calculus.pdf",
        thumbnailPath: null,
        uploaderId: "user-1",
        downloads: 45,
        views: 89,
      ...
      },
      {
        ...
        description: "Detailed notes on binary trees, BSTs, AVL trees, and tree traversal algorithms with code examples",
        subject: "Computer Science",
        tags: ["algorithms", "data-structures", "trees", "programming"],
        course: "CS 341",
        ...
        fileSize: 3145728,
        filePath: "/uploads/sample-dsa.pdf",
        thumbnailPath: null,
        uploaderId: "user-2",
        downloads: 78,
        views: 156,
      ...
      },
      {
        ...
        description: "Introduction to wave functions, Schrödinger equation, and quantum states with solved problems",
        subject: "Physics", 
        tags: ["quantum-mechanics", "wave-functions", "schrodinger", "physics"],
        course: "PHYS 443",
        professor: "Dr. Wilson", 
        semester: "Fall 2024",
        fileType: "pdf",
        fileName: "quantum-waves.pdf",
        fileSize: 4194304,
        filePath: "/uploads/sample-quantum.pdf", 
        thumbnailPath: null,
        uploaderId: "user-3",
        downloads: 32,
        views: 67,
      ...
      },
      {
        ...
        description: "Essential matrix operations, eigenvalues, eigenvectors, and applications",
        subject: "Mathematics",
        ...
        fileSize: 1572864,
        filePath: "/uploads/sample-linear.pdf",
        thumbnailPath: null,
        uploaderId: "user-1", 
        downloads: 56,
        views: 102,
      ...
      },
      {
        ...
        description: "Process scheduling, synchronization, deadlocks, and memory management concepts",
        subject: "Computer Science",
        tags: ["operating-systems", "processes", "scheduling", "memory"],
        course: "CS 385",
        professor: "Prof. Davis",
        semester: "Fall 2024",
        fileType: "pdf", 
        fileName: "os-processes.pdf",
        fileSize: 2621440,
        filePath: "/uploads/sample-os.pdf",
        thumbnailPath: null,
        uploaderId: "user-2",
        downloads: 34,
        views: 71,
    ...
    sampleNotes.forEach(note => {
      this.notes.set(note.id, note as Note);
    });

    // Add some sample ratings
    const sampleRatings = [
      { id: "rating-1", noteId: "note-1", userId: "user-2", rating: 5, review: "Excellent notes! Very clear explanations.", createdAt: new Date("2024-10-02") },
      { id: "rating-2", noteId: "note-1", userId: "user-3", rating: 4, review: "Good coverage of integration techniques.", createdAt: new Date("2024-10-03") },
      { id: "rating-3", noteId: "note-2", userId: "user-1", rating: 5, review: "Best data structures notes I've found!", createdAt: new Date("2024-09-30") },
      { id: "rating-4", noteId: "note-2", userId: "user-3", rating: 5, review: "Clear examples and great diagrams.", createdAt: new Date("2024-10-01") }
    ];

    sampleRatings.forEach(rating => {
      this.ratings.set(rating.id, rating as Rating);
    });

    // Add some sample comments
    const sampleComments = [
      { id: "comment-1", noteId: "note-1", userId: "user-2", content: "Thanks for sharing! This helped me understand integration by parts much better.", parentId: null, createdAt: new Date("2024-10-02") },
      { id: "comment-2", noteId: "note-2", userId: "user-1", content: "Could you add more examples of tree rotations?", parentId: null, createdAt: new Date("2024-09-30") },
      { id: "comment-3", noteId: "note-2", userId: "user-2", content: "Sure! I'll update the notes soon with more rotation examples.", parentId: "comment-2", createdAt: new Date("2024-10-01") }
    ];
    ...
    console.log("Sample data initialized: 3 users, 5 notes, 4 ratings, 3 comments");
  }
